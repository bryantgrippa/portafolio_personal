...
<div class="container">
    <center>
        <div class="container">
            <form class="well form-horizontal"  id="frm-changepss" action="?p=rrhh&c=Perfiles&a=Modificarp" method="post" enctype="multipart/form-data">
        ...
        function confirmar(texto) {
            ...
            Swal
                    .fire({
                        html:
                                '<h3>Modificado:</h3>' +
                                '<p>Su contraseña se modificó.</p>'
                    })
                    .then(resultado => {
                        if (resultado.value) {
                            location.href = "mi_perfil.php?p=rrhh&c=Mi_perfil&a=Pass&id_usuario=<?php echo $_SESSION['id_usuario']; ?>";
                        }
                    });
        }
        confirmar();</script>
