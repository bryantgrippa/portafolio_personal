...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 style="color:red;">PORTABILIDAD</h1>
</div>
<form method="post" action="?p=claro&c=Usuario_porta&a=saveporta" method="post" enctype="multipart/form-data">
    <input type="hidden" name="tipo_solicitud" value="PORTABILIDAD"></imput>
                        ...
                        <div class="card-body">
                            <div class="container2">
                                ...
                                <input type="text" name="nombres" require class="form-control" required>
                                    ...
                                    <input type="date" name="fecha_nacimiento" required class="form-control" min="1900-01-01" max="<?php echo date('Y-m-d'); ?>">

                                    <label class="form-label">Fecha de expedicion</label>
                                    <input type="date" name="fecha_expedicion" required class="form-control" min="1900-01-01" max="<?php echo date('Y-m-d'); ?>">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="collapse" id="collapseCardExample3">
                        <div class="card-body">
                            ...
                            <input name="min" type="number" id="subopcion" placeholder="MIN" class="form-control" oninput="javascript: if (this.value.length > 12) this.value = this.value.slice(0, 12);" min="0" max="99999999999" value="0" required>
                            ...
                            <label for="" class="form-label">Operador Donante</label>
                            <select class="form-control" name="operador_donante" required>
                            <option value="" selected disabled>Elegir</option>
                            ...
                            <input name="nip" type="number" id="subopcion" placeholder="NIP" class="form-control" oninput="javascript: if (this.value.length > 5) this.value = this.value.slice(0, 5);" min="0" max="99999999999" required value="0">
                            ...
                            <input name="numero_sim" type="number" id="subopcion" placeholder="N°" class="form-control" oninput="javascript: if (this.value.length > 12) this.value = this.value.slice(0, 12);" min="0" max="99999999999999" required value="0">

                            <label class="form-label">N° MIN SIM comprada</label>
                            <input name="numero_min_sim" type="number" id="subopcion" placeholder="N°" class="form-control" oninput="javascript: if (this.value.length > 12) this.value = this.value.slice(0, 12);" min="0" max="99999999999" required value="0">
                        </div>
                    </div>
                </div>
