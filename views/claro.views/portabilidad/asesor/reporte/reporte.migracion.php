...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 style="color:red;">MIGRACION</h1>
</div>
<form method="post" action="?p=claro&c=Usuario_porta&a=savemigracion" method="post" enctype="multipart/form-data">
    <input type="hidden" name="tipo_solicitud" value="MIGRACION"></imput>
