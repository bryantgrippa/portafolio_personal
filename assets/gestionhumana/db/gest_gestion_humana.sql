...
--
-- Servidor: localhost
-- Tiempo de generación: 08-07-2024 a las 11:58:45
...
(1, 'ADMINISTRATIVO', 1),
(2, 'STAFF OPERATIVO', 1),
(3, 'AREA DE APOYO (SOPORTE, DESARROLLO)', 1);
...
(1, 'Administrador', 1),
(2, 'Gerencia', 1),
(3, 'Director Administrativo y Financiero (Nomina)', 1),
...
CREATE TABLE `destacados` (
  ...
  `imagen` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT 'assets/img/user/defecto.png',
...
CREATE TABLE `solicitudes_permisos_laborales` (
  ...
  `horario_permiso_salida` time DEFAULT NULL,
  `horario_permiso_entrada` time DEFAULT NULL,
  ...
  `archivo` varchar(5000) DEFAULT NULL,
  `correo_sup` varchar(50) DEFAULT NULL,
  `correo_jefe_area` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `solicitudes_permisos_laborales`
--
-- --------------------------------------------------------
...
(2, 'Bryant Gilberto Grippa Blanco', 'bryant.grippa', '$2y$10$xVHLm03fepd45mhHDi6TB.Em3zGHQySBFLbAO1p4hcc1sDSO/q2Ru', '1251459', '2003-03-21', '2023-11-01', 1, 'Desarrollador web', 'Millon trecientos mil', 1300000, 'assets/img/user/defecto.png', 'bryant_grippa@soy.sena.edu.co', 3, 0, 0, 0, 0, 0, 0, 0, 1, 0, 'M', '2024-01-15 15:41:09', '2024-06-25 14:23:12', 1, 4, 2, 0);
--
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `Area` FOREIGN KEY (`area`) REFERENCES `areas` (`id_area`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Cargo` FOREIGN KEY (`cargo`) REFERENCES `cargos` (`id_cargo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Permisos` FOREIGN KEY (`permiso`) REFERENCES `permisos` (`id_permiso`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
